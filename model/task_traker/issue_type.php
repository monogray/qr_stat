...
class IssueType extends Table_Entity{
	public $table_name = 'issue_type';
	...
	static public function getInstance(){
		if(IssueType::$instance == null){
			IssueType::$instance = new IssueType();
			IssueType::$instance->getMainList();
		}
		return IssueType::$instance;
	}
	...
	public function setValuesByInstanceAndIdLazy($_id) {
		$_instance = IssueType::getInstance();
